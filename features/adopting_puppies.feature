...
Scenario: Adopting two puppies
    ...
    And I press the View Details button for "Hanna"
...
Scenario: Adopt a puppy using the table
...
Then I should see "Thank you for adopting a puppy!"
   ...
   Scenario: Adopt a puppy using partial default data
   When I press the View Details button for "Brook"
   And I press the Adopt Me button
   And I press the Complete the Adoption button
...
Scenario: Thank you message should display after adoption is finished
